...
#table 6
  ...
  #var 19 (unavailable in UIS API)

  #var 20
  "https://api.uis.unesco.org/sdmx/data/UNESCO,EDU_NON_FINANCE,2.0/OE.PER.L5T8._T._T.._T.INST_T............W00.?format=sdmx-compact-2.1&lastNObservations=1&subscription-key=",
